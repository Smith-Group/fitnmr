...
script_lines <- readLines(file.path("refine", "refit_peaks_2d.R"))
script_lines <- sub("mc_cores <- getOption\\(\"mc.cores\", parallel::detectCores\\(\\)\\)", "mc_cores <- 1", script_lines)
writeLines(script_lines, file.path("refine", "refit_peaks_2d.R"))
```
